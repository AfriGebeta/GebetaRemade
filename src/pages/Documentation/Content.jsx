...
const IntroPage = () => {
    ...
    <div className="w-[90%] md:w-[80%] md:ml-[0%] ml-[3%]">
        ...
        <p className="md:mt-[2%] text-[#A0AABA] md:text-2xl text-xl md:ml-[0%] ml-[3%]" style={{ fontFamily: "Zen Dots" }}>
            ...
            <p className="mt-[1%]">
            Simultaneously, the Node.js SDK has been engineered to handle the server-side aspects of GebetaMaps integration. This SDK is tailored for back-end development, allowing developers to employ Node.js's asynchronous and event-driven architecture to efficiently manage communication with GebetaMaps services. Through API calls and server-side logic, developers can harness the power of the Node.js SDK to fetch and manipulate data, ensuring that the GebetaMaps integration is both robust and scalable.
            </p>

            <p className="mt-[1%]">
            Both SDKs, though distinct in their purposes, work in tandem to create a comprehensive solution for GebetaMaps integration. The Dart SDK optimizes the front-end development process within Flutter, while the Node.js SDK manages server-side interactions, collectively providing developers with a versatile toolkit to seamlessly incorporate GebetaMaps functionalities into their applications. This dual SDK approach underscores our commitment to offering developers flexibility and efficiency in integrating GebetaMaps across a spectrum of application environments.

            </p>
            <p className="mt-[1%]"> 
            For comprehensive details on integrating GebetaMaps into your Dart-based applications using our Dart SDK, please visit <a className="text-blue-600" href="https://pub.dev/packages/gebetamap/example">https://pub.dev/packages/gebetamap/example</a>. This resource provides a wealth of information, including code examples and usage guidelines, enabling developers to seamlessly incorporate GebetaMaps functionalities into their Flutter projects. Additionally, for Node.js developers seeking insights into server-side integration, the Node.js SDK documentation can be found at <a className="text-blue-600" href="https://www.npmjs.com/package/gebetamap?activeTab=versionse">https://www.npmjs.com/package/gebetamap?activeTab=versions</a>. Here, you'll discover valuable resources, documentation, and version-specific details to streamline the process of integrating GebetaMaps into your Node.js-based applications. Explore these links to access comprehensive documentation and ensure a smooth and efficient integration of GebetaMaps into your projects.
            </p>
...
const Content = ({object , current}) => {
    ...
    const returnContent = () => {
        return current == "intro" ? (<IntroPage/>) :
             (
                <div className="w-[90%] md:w-[80%] md:ml-[0%] ml-[3%]">
                    <p className="mt-[2%]">
                        {object.introduction}
